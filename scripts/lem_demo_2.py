...
parser.add_argument('--gen_args', nargs='+', default=[10,2,1], type=float, help='Arguments to the curve generator.')
...
def main():
    ...
    xref, uref, t = gen_xref_uref_from_xyz(xyz, args.T, dt, translate=False, debug=True)
    with new_ref_lock:
        new_xref = xref
        new_uref = uref
